...
<div id="page-content-outer">
    <div id="page-content" class="wrapper content admin">
        ...
        <h5 class="breadcrumbs secondary">
            <a href="<?php echo $breadcrumbs[1][1]; ?>"><?php echo $breadcrumbs[1][0];?></a>
        </h5>
        ...
        <div class="row">
            ...
            <div class="two columns">
                    ...
                    <div class="row">
                            <div class="info-bar">
                                <h1 class="title ostrich-medium tall"><?php echo $breadcrumbs[0][0]; ?></h1>
                                
                            <div id="clientLogo"><img src="<? echo $dir . $_SESSION['logo_id']; ?>" width="200" /></div>
                            </div>
                ...
                <div class="ten columns">
                    <div class="client-projects">
                        ...
                        if (is_array($projects) > 0)
                        {
                            ...
                            echo "<h3 class='project-list ostrich-medium tall'>".$lang["lang_projects"]."</h3>";
                        ...
                        if (is_array($invoices))
                        {
                            ...
                            $this->set('details_link', $details_link);
                            $this->set('details_id_field', $details_id_field);
                            echo "<h3 class='invoice-list ostrich-medium tall'>".$lang["lang_invoices"]."</h3>";
                            $this->loadView('fluid-list', false);
                        }
                        else
                        {
