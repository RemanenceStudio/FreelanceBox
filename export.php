...
///////////////////////////////////////////////////////////////////////////////////
			...
			//Enregistrement du timesheet
			$idFile = date("d-m-Y-His");
			$sql = "INSERT INTO `timesheets` VALUES (NULL, '" .$_SESSION['auth_id']. "', '" .$_POST['agenda']. "', 'timesheet" .$idFile. "')";
			mysql_query($sql);

			$sql = "SELECT * FROM `google` WHERE `id` = " . $_POST['agenda'];
			$rs = mysql_query($sql);
...
///////////////////////////////////////////////////////////////////////////////////
		...
		// parameters
		$calendar_user = $row['code_user'];
		$calendar_visibility = $row['code_visibility'];
		$start_date = $_POST['dd'];
		$end_date = $_POST['df'];
...
// Get Details Admin
$sql = "SELECT * FROM `clients` WHERE `id` = " . $_SESSION['auth_id'];
$rs = mysql_query($sql);
$row = mysql_fetch_array($rs);
...
<table border=0 cellpadding=0 cellspacing=0 width=700 style='border-collapse:
 ...
 collapse;table-layout:fixed;width:527pt'>
    ...
    <tr height=17 style='height:12.75pt'>
        ...
        <td colspan=6 class=xl78 width=504 style='width:380pt'>" .$row['contact_person']. "</td>
    </tr>
    <tr height=17 style='height:12.75pt'>
        <td height=17 style='height:12.75pt'></td>
        <td colspan=2 class=xl65 width=167 style='width:125pt'>Adress</td>
        <td colspan=6 class=xl78 width=504 style='width:380pt'><span class=\"xl781\" style=\"width:380pt\">" .$row['address_line_1']. "</span></td>
    </tr>
    <tr height=23 style='mso-height-source:userset;height:17.25pt'>
        <td height=23 style='height:17.25pt'></td>
        <td class=xl65 width=120 style='width:90pt'>Postcode</td>
        <td></td>
        <td colspan=6 class=xl87 width=504 style='width:380pt'><span class=\"xl782\" style=\"width:380pt\">" .substr($row['address_line_2'], 0, 5). "</span></td>
    </tr>
    <tr height=20 style='height:15.0pt'>
        <td height=20 style='height:15.0pt'></td>
        <td class=xl65 width=120 style='width:90pt'>City</td>
        <td></td>
        <td colspan=6 class=xl78 width=504 style='width:380pt'><span class=\"xl783\" style=\"width:380pt\">" .substr($row['address_line_1'], 6). "</span></td>
    </tr>
    <tr height=23 style='mso-height-source:userset;height:17.25pt'>
        <td height=23 style='height:17.25pt'></td>
        <td class=xl65 width=120 style='width:90pt'>Country</td>
        <td></td>
        <td colspan=6 class=xl78 width=504 style='width:380pt'><span class=\"xl784\" style=\"width:380pt\">FRANCE</span></td>
    </tr>
    <tr height=23 style='mso-height-source:userset;height:17.25pt'>
    ...
    <tr height=24 style='mso-height-source:userset;height:18.0pt'>
        ...
        <td colspan=3 class=xl81 width=165 style='border-left:none;width:125pt'><span class=\"xl787\" style=\"width:380pt\">" .$row['name']. "</span></td>
        <td class=xl71 style='border-top:none;border-left:none'>" .date("m/d/Y"). "</td>
        <td class=xl69 width=65 style='border-left:none;width:49pt'>&nbsp;</td>
    </tr>
    <tr height=23 style='mso-height-source:userset;height:17.25pt'>
 ...
 //foreach ($event_list as $event) {
    ...
    $str .= "<tr height=23 style='mso-height-source:userset;height:17.25pt'>
        <td height=23 class=xl70 style='height:17.25pt;border-top:none'>" .$dayNumber. "</td>
        <td class=xl74 style='border-top:none;border-left:none'>" .$dayAlpha. "</td>
        <td colspan=6 class=xl70 style='border-left:none'>" .$title. "</td>
        <td class=xl69 width=65 style='border-left:none;width:49pt'>&nbsp;</td>
    </tr>";
  ...
  style='mso-spacerun:yes'> </span></td>
        <td class=xl75 style='border-top:none;border-left:none'>" .count($tabTest). "</td>
        <td class=xl69 width=65 style='border-left:none;width:49pt'>&nbsp;</td>
    </tr>
    <tr height=20 style='height:15.0pt'>
...
$file = 'timesheet' . $idFile . '.xls';
$fp = fopen('ds/timesheets/' . $file , 'w+');
fputs($fp, $str);
fclose($fp);
